...
void main() async {
  await runZonedGuarded(() async {
    ...
    await ConfigEnvironments.setCurrentEnvironments(Environments.STAGING);
    if (Platform.isAndroid) {
      await FCMService.to.init(DefaultFirebaseOptions.sandboxAndroid);
    } else {
      await FCMService.to.init(DefaultFirebaseOptions.sandboxIOS);
    }
